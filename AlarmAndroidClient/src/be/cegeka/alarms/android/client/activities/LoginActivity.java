...
public class LoginActivity extends Activity
{
	...
	private RemoteDBConnectionInterface connectionInterface;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setRemoteDBConnectionInterface(new RemoteDBWebConnection());
		setupActionBar();
	 ...
	 * the user.
	 */
	public class UserLoginTask extends AsyncTask<Void, Void, UserTO>
	{
		@Override
		protected UserTO doInBackground(Void... params)
		{
			UserTO user = connectionInterface.login(mEmail, mPassword);
		...
		@Override
		protected void onPostExecute(final UserTO user)
		{
			mAuthTask = null;
			showProgress(false);
	 ...
	 * ONLY FOR TESTING.
	 * 
	 * @param remoteDBConnectionInterface
	 */
	public void setRemoteDBConnectionInterface(RemoteDBConnectionInterface remoteDBConnectionInterface)
	{
		this.connectionInterface = remoteDBConnectionInterface;
	}
}
