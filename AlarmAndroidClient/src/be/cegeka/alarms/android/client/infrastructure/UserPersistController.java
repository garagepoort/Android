...
class UserPersistController
{
	 ...
	 * @throws IOException
	 */
	public void saveUser(Context ctx, UserTO user) throws IOException
	{
	 ...
	 */
	public UserTO loadUser(Context ctx)
	{
		SharedPreferences settings = ctx.getSharedPreferences("file", 0);
	 ...
	 * @throws IOException
	 */
	public void deleteUser(Context ctx) throws IOException
	{
		SharedPreferences settings = ctx.getSharedPreferences("file", 0);
		SharedPreferences.Editor editor = settings.edit();
		editor.clear();
