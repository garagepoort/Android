...
import static be.cegeka.memento.infrastructure.PropertyReader.getProperty;
...
public class AddTagTask extends FutureTask<Void, String>
{
	...
	private SoapObject soapGetAlarmsFromUserResponse(String tag) throws IOException, XmlPullParserException, SocketTimeoutException {
